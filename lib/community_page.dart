    ...
    return Scaffold(
        ...
        child: Stack(
          children: [
                   ...
                   // D9D9D9 color with 35% opacity
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Image.asset(
                          'images/chat-bulle.png', // Replace with your image path
            ...
            Positioned(
              ...
              right: 16,
              child: Image.asset(
                'images/femme.png', // Replace with your image path
                width: 42,
                height: 42,
              ),
            ),
      ...
      bottomNavigationBar: CurvedNavigationBar(
        ...
        Container(
          ...
          child: Image.asset('images/robot.png'), // Replace with your own icon
        ), // Replace with your own icon
        Icon(Icons.favorite),
        Container(
          width: 30, // Adjust the width as needed
          height: 30, // Adjust the height as needed
          child: Image.asset('images/code-barres-lu.png'), // Replace with your own icon
        ),
        // Replace with your own icon
        // Replace with your own icon
        Icon(Icons.home),
        Container(
          width: 30, // Adjust the width as needed
          height: 30, // Adjust the height as needed
          child: Image.asset('images/amis.png'), // Replace with your own icon
        ),
        // Replace with your own icon
         // Replace with your own icon
